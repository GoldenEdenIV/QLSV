...
public:
    ...
    QPushButton *listSubjectsButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        listClassesButton->setGeometry(QRect(0, 240, 161, 41));
        ...
        editClassButton->setGeometry(QRect(0, 100, 161, 41));
        addClassButton = new QPushButton(tab);
        addClassButton->setObjectName("addClassButton");
        addClassButton->setGeometry(QRect(0, 30, 161, 41));
        ...
        addSubjectButton->setGeometry(QRect(0, 30, 161, 41));
        editSubjectButton = new QPushButton(tab_2);
        editSubjectButton->setObjectName("editSubjectButton");
        editSubjectButton->setGeometry(QRect(0, 100, 161, 41));
        ...
        listSubjectsButton = new QPushButton(tab_2);
        listSubjectsButton->setObjectName("listSubjectsButton");
        listSubjectsButton->setGeometry(QRect(0, 240, 161, 41));
        ...
        listAllStudentsButton = new QPushButton(tab_3);
        listAllStudentsButton->setObjectName("listAllStudentsButton");
        listAllStudentsButton->setGeometry(QRect(0, 30, 161, 41));
        ...
        deleteStudentButton->setGeometry(QRect(0, 240, 161, 41));
        ...
        editCreditClassButton->setGeometry(QRect(0, 100, 161, 41));
        ...
        enterScoresButton->setGeometry(QRect(0, 310, 161, 41));
        addCreditClassButton = new QPushButton(tab_4);
        addCreditClassButton->setObjectName("addCreditClassButton");
        addCreditClassButton->setGeometry(QRect(0, 30, 161, 41));
        ...
        printScoresButton = new QPushButton(tab_4);
        printScoresButton->setObjectName("printScoresButton");
        printScoresButton->setGeometry(QRect(0, 450, 161, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        editCreditClassButton->setText(QCoreApplication::translate("MainWindow", "S\341\273\255a l\341\273\233p TC", nullptr));
